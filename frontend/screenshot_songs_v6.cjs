...
(async () => {
  ...
  // Wait for the rows to populate (they get titles after hydration!)
  await page.waitForSelector('text="There’s a gospel of today"', { timeout: 15000 }).catch(() => {});
  
  await page.locator('text=Present').click();
  
  // Wait for the loading spinner in presentation mode to disappear!
  await page.waitForSelector('text=Loading Songs...', { state: 'hidden', timeout: 15000 }).catch(() => {});
  ...
  await page.screenshot({ path: '/Users/david/.gemini/antigravity-ide/brain/c1b854b1-f6fe-4c06-8f88-d423c10df7d6/song18_v6.png' });
  console.log("Screenshot saved to song18_v6.png");
